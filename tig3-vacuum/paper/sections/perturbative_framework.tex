...
Due to the static spherical symmetry of the representative background geometry, perturbative modes may be decomposed into angular sectors \cite{reggewheeler1957,zerilli1970,vishveshwara1970}.
...
The tortoise coordinate regularizes the perturbative radial structure near simple horizon sectors and allows the perturbation equations to be expressed in Schrödinger-type form \cite{reggewheeler1957,chandrasekhar1983}.
...
{figures/tig3_effective_potential.png}
\caption{
Representative operator-theoretic structure associated with the TIG3 perturbative admissibility framework.
The figure schematically summarizes the relation between the perturbative operator sector, admissibility conditions, representative geometry, and bounded-curvature vacuum structure.
The diagram is interpretive and intended as a structural overview rather than a rigorous closure theorem.
}
\label{fig:tig3_effective_potential}
\end{figure}
...
Thus the perturbative sector remains compatible with the classical far-field regime \cite{wald1984,chandrasekhar1983}.
...
In particular, lower-boundedness of $Q[\psi]$ is required for controlled spectral behavior and bounded linear evolution \cite{friedrichs1934,reedsimon2,kato1995}.
...
obtained through quadratic-form methods and admissible endpoint classification \cite{friedrichs1934,reedsimon2,reedsimon4,weidmann1987}.
...
Condition (\ref{eq:spectral_condition}) excludes negative spectral modes corresponding to exponentially growing perturbative instabilities \cite{davies1996,teschl2009}.
