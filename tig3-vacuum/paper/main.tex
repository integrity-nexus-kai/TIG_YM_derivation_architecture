...
In addition, we investigate the effective stress-energy structure associated with the representative geometry together with the semiclassical Hawking-temperature sector and extremal-limit behavior.
...
\input{sections/introduction_and_geometry}

\input{sections/perturbative_framework}

\input{sections/energy_conditions_and_thermodynamics}

\input{sections/conclusions_and_limitations}
